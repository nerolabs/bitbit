...
> **⚠️ ARCHIVED (2026-08-06) — historical first-cut design note (2026-08-01).**
> For the current as-built, read [`m0.md`](../../docs/design/m0.md) §6 (S1 — the
> shipped surface) and [`m0-sybil-rebind.md`](../../docs/design/m0-sybil-rebind.md)
> (the v3 bond as-built). The still-current **wire protocol** this note introduced
> (bond gossip fields, `MsgBondChallenge`/`MsgBondReply`, the auditor loop) is
> summarized in the live stub [`docs/design/bond-audit.md`](../../docs/design/bond-audit.md).
> The bond is **one axis (D — distinct sealed disk per identity) of M0's systemic
> composition**, not "the Sybil corner"; the systemic claim lives in `m0.md`.
...
[`m0.md`](../../docs/design/m0.md) §3); the systemic claim lives in `m0.md`, not in this one
...
> rebind** ([`m0-sybil-rebind.md`](../../docs/design/m0-sybil-rebind.md)): the disk-persisted,
